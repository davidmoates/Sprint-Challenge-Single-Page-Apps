...
> Answer: Client-Side Routing will help with speed because it does not send HTTP GET request. Also it help make the experience more unique for the consumer.
...
- [x]  Use a styling or component library for part of or all of your application. (Pick at least 1 of: [s](https://react-bootstrap.github.io/)styled-components or Reactstrap).
